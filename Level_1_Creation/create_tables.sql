CREATE TABLE Sellers ( -- done gd file
...
CREATE TABLE Categories ( -- done with file
...
CREATE TABLE OrderDetails ( --done need to gd file
...
CREATE TABLE Buyers ( --done mockaroo
...
CREATE TABLE Products ( -- done txt file
  product_id INT NOT NULL,
...
CREATE TABLE Orders ( --done gd files
...
CREATE TABLE Reviews ( --done gd file
